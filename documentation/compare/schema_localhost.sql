...
CREATE TABLE story (
    ...
    wiki_page character varying(255),
    author_id bigint,
    project_projectid bigint,
...
--
-- Name: fk_foqxjaes96bqce73nrxjw3h1d; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fk_k19fghkdh96dr10u9ryt0v9op; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
